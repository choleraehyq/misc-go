...
"".main.func1 STEXT size=25 args=0x0 locals=0x0
	0x0000 00000 (main.go:10)	TEXT	"".main.func1(SB), ABIInternal, $0-0
	0x0000 00000 (main.go:10)	MOVQ	(TLS), CX
	0x0009 00009 (main.go:10)	CMPQ	SP, 16(CX)
	0x000d 00013 (main.go:10)	PCDATA	$0, $-2
	0x000d 00013 (main.go:10)	JLS	18
	0x000f 00015 (main.go:10)	PCDATA	$0, $-1
	0x000f 00015 (main.go:10)	PCDATA	$0, $-2
	0x000f 00015 (main.go:10)	PCDATA	$1, $-2
	0x000f 00015 (main.go:10)	FUNCDATA	$0, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x000f 00015 (main.go:10)	FUNCDATA	$1, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x000f 00015 (main.go:10)	FUNCDATA	$2, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x000f 00015 (main.go:11)	XCHGL	AX, AX
	0x0010 00016 (main.go:1048575)	JMP	15
	0x0012 00018 (main.go:1048575)	NOP
	0x0012 00018 (main.go:10)	PCDATA	$1, $-1
	0x0012 00018 (main.go:10)	PCDATA	$0, $-2
	0x0012 00018 (main.go:10)	CALL	runtime.morestack_noctxt(SB)
	0x0017 00023 (main.go:10)	PCDATA	$0, $-1
	0x0017 00023 (main.go:10)	JMP	0
	0x0000 65 48 8b 0c 25 00 00 00 00 48 3b 61 10 76 03 90  eH..%....H;a.v..
	0x0010 eb fd e8 00 00 00 00 eb e7                       .........
	rel 5+4 t=17 TLS+0
	rel 19+4 t=8 runtime.morestack_noctxt+0
...
go.debuglines."".main.func1 SDWARFMISC size=21
	0x0000 04 02 03 04 14 a6 03 ef ff 3f 1e 03 8f 80 40 1f  .........?....@.
	0x0010 04 01 03 77 01                                   ...w.
